        ...
        <div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form class="avatar-form" action="/admin/upload/avatar" enctype="multipart/form-data" method="post">
        {!! csrf_field() !!}
...
<form class="form-horizontal" role="form" action='/admin/agent/{{ $agent->id }}' method="POST">
{!! csrf_field() !!}
{!! method_field('PUT') !!}
<input type="hidden" name="avatar" value='{{ $agent->avatar }}' id='avatar_val'>
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name='room_id' value='{{ $agent->room_id}}'>
