	...
	<script>
		$(function(){
			$('.w-want-accept-native').on('touchstart',function(){
				window.location.href='/wechat/order/index3#aimto';
			})
		})
	</script>
